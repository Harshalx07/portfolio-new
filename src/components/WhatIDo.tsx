        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Architecting and managing secure, scalable environments across multi-cloud platforms.
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVOPS & CI/CD</h3>
              <h4>Continuous Integration & Delivery</h4>
              <p>
                Building seamless deployment pipelines and managing containerized workloads.
                Integrating security practices for robust delivery.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
